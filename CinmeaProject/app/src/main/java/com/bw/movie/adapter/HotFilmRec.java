 ...
 * @Description：描述信息
 */
public class HotFilmRec extends RecyclerView.Adapter<HotFilmRec.holder> {

    List<RoateBean.ResultBean> list;
    Context context;
    CinemaFragment cinemaFragment;

    public HotFilmRec(List<RoateBean.ResultBean> list, Context context,CinemaFragment cinemaFragment) {
        this.list = list;
    ...
    public holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = View.inflate(context, R.layout.layout_hotefilm,null);
