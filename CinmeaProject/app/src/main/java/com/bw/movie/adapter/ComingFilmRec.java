 ...
 * @Description：描述信息
 */
public class ComingFilmRec extends RecyclerView.Adapter<ComingFilmRec.holder> {

    List<ComingBean.ResultBean> list;
    Context context;
    CinemaFragment cinemaFragment;
    public ComingFilmRec(List<ComingBean.ResultBean> list, Context context, CinemaFragment cinemaFragment) {
    ...
    public holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = View.inflate(context, R.layout.layout_comingfilm,null);
    ...
    public class holder extends RecyclerView.ViewHolder{
        @BindView(R.id.ComingFilmSim_id)
